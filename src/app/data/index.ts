...
export const applications: RequestPayload[] = [
  {
    _token: "agGKCi0ZjFQ689aR30xf1MlTpmdrPARdk171j4kM",
    apiKey: "agGKCi0ZjFQ689aR30xf1MlTpmdrPARdk171j4kM",
    action: "sendOtp",
    info: [
      {
        web_id: "BGDDW1464B24",
  ...
  {
    _token: "RLVlxzniwHJLVKxT1FQWNQjcMVakHWdoFCInI6sQ",
  ...
  {
    _token: "L8SSlc4wWzNGGgcvDDRtBwpQ2bElGnBweUMkwFGq",
    apiKey: "L8SSlc4wWzNGGgcvDDRtBwpQ2bElGnBweUMkwFGq",
    action: "sendOtp",
    info: [
      {
        web_id: "BGDDW1464B24",
